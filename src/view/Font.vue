<template>
  <div class="font read">
    ...
    <span class="hljs-attribute">font-family</span>: -apple-system, BlinkMacSystemFont, <span class="hljs-string">"Segoe UI"</span>, Roboto,
      ...
      <h2 id="字号">
        <a class="header-link" href="#字号"></a>字号</h2>
      <p>字号的不同，决定了想要传达信息的重要性的不同。默认字体为
        <code>12px</code>或
      ...
      <Row>
        <Col span="12">
        <p>字体颜色的选择一定要考虑字体所在背景的颜色，简单来说就是
          <code>浅背景深字体，深背景浅字体</code>
        </p>
        </Col>
